...
const ALL_SHAPES = ['bunny','cat','dog','bear','frog','duck','elephant','owl','fish','turtle','hedgehog','penguin','butterfly','mushroom','balloon','flower','house','tree','star','heart','car','rocket','snowman','sun','robot','sprunkiOrange','sprunkiRed','sprunkiSilver','sprunkiFunBot','sprunkiGreen','sprunkiGray','sprunkiBrown','sprunkiGold','sprunkiLime','sprunkiSky','sprunkiMrSun','sprunkiPurple','sprunkiMrTree','sprunkiYellow','sprunkiTan','sprunkiMrFunComp','sprunkiWenda','sprunkiPinki','sprunkiJevin','sprunkiBlack'];
